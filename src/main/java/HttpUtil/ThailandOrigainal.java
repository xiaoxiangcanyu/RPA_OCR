 ...
 * 泰国工厂发票数据处理
 */
public class ThailandOrigainal extends BaseUtil {
...
//        String filePath1 = args[4];
        ...
        String filePath = "C:\\Users\\songyu\\Desktop\\haier_rpa所有资料\\OCR_Data\\项目交接文档\\项目交接文档\\AP\\新加坡用horis的国家\\泰国工厂\\pic\\6560-FAC-1901235186.jpg";
    ...
    public static List getFilePathDate(String filePath) throws Exception {
        ...
        System.out.println("表格的最后一行行数:"+sheet.getLastRowNum());
