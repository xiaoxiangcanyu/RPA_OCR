...
//        String filePath = "C:\\Users\\songyu\\Desktop\\haier_rpa所有资料\\OCR_Data\\项目交接文档\\项目交接文档\\AR\\中东AR\\20190402\\AR_Matching_List.xlsx";//全量台账数据表
//        String filePath_sap = "C:\\Users\\songyu\\Desktop\\haier_rpa所有资料\\OCR_Data\\项目交接文档\\项目交接文档\\AR\\中东AR\\20190402\\FB01_2.xlsx";//生成sap表路径
//        String filePath_cost = "C:\\Users\\songyu\\Desktop\\haier_rpa所有资料\\OCR_Data\\项目交接文档\\项目交接文档\\AR\\中东AR\\20190402\\MappingList.xls";//对照表数据
//        try {
//            // 获取台账数据
//            List<MiddleEastAll> MiddleEastLedgerList = getLedgerExcelData(filePath);
//            //生成FB01数据
//            List<MiddleEastSAP> middleEastSAPList = getMiddleEastSAP(MiddleEastLedgerList,filePath,filePath_cost,result);
//
...
//     * @throws Exception
//     * */
//    public static List getMiddleEastSAP(List<MiddleEastAll>  MELedgerList, String filePath, String filePath_Cost, String result) throws Exception {
//        //台账中id相同的数据的处理
...
//            if (incomeNo.length() < 10 && !"".equals(middleEastAll.getSapIncomeNo())){
...
//        }
//        //获取TT类型数据的SAP数据
//        List<MiddleEastSAP> middleEastTtSAPList = cleanTtDataSap(MENowIncomeTtList,MEIncomeTtList, MENowChargeTtList, MEOthChargeTtList, map, filePath_Cost);
//
//
//        //一次性客户类型数据本月认领
////        System.out.println("一次性客户：" +MEForOtherTtIncomeList.size());
//        List<MiddleEastSAP> middleEastForOtherTtSAPList = cleanForOtherTtDataSap(MEForOtherTtIncomeList,MEIncomeTtList,MEForOtherTtChargeList,map,filePath_Cost);
...
//                if ("".equals(middleEast.getCustomerCode()) && "".equals(middleEast.getSapNoForOther()) && incomeNo.length() < 10 ){
//                    //收款不为空，扣款为空
...
//     * @param map
//     */
//    public static List cleanTtDataSap(List<MiddleEastAll> MENowIncomeTtList, List<MiddleEastAll>  MEIncomeTtList, List<MiddleEastAll>  MENowChargeTtList, List<MiddleEastAll> MEOthChargeTtList,  Map<String,List<MiddleEastAll>> map, String filePath_Cost)throws Exception{
//        List<MiddleEastSAP> middleEastSAPList = new ArrayList<>();
...
//            if (num == lists.size()){
////                System.out.println("重复的id数据处理！" + lists.size());
//                MiddleEastSAP middleEastSAP = new MiddleEastSAP();
...
//     * @throws Exception
//     */
//    public static List cleanForOtherTtDataSap(List<MiddleEastAll> MENowIncomeTtList, List<MiddleEastAll>  MEIncomeTtList, List<MiddleEastAll>  MENowChargeTtList, Map<String,List<MiddleEastAll>> map, String filePath_Cost)throws Exception {
//        List<MiddleEastSAP> middleEastSAPList = new ArrayList<>();
//        if (MEIncomeTtList.size() > 0){
//            for (MiddleEastAll middleEast : MENowIncomeTtList){
//                MiddleEastSAP middleEastSAP = new MiddleEastSAP();
...
//            //遍历所有的正数数据集合，统计ID与合并单元格数据ID相等的数据的数量
//            for (MiddleEastAll middleEast : MEIncomeTtList){
//                if (key.equals(middleEast.getId()) && "".equals(middleEast.getSapIncomeNo()) && !"".equals(middleEast.getSapNoForOther())){
//                    num = num + 1;
//                }
//            }
//            List<MiddleEastAll> lists = map.get(key);
